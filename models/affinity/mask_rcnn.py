    ...
    def __init__(self, backbone, num_classes=None,
        ...
        if mask_roi_pool is None:
            mask_roi_pool = MultiScaleRoIAlign(
                ...
                sampling_ratio=2)
            # duplicate the layer
            #mask_roi_pool_s2 = MultiScaleRoIAlign(
            #    #Alex: the key of the feature map
            ##    featmap_names=['0'],
            #    output_size=14,
            #    sampling_ratio=2)
        ...
        if mask_head is None:
            ...
            # replicate the layer for the classification module
        ...
        if mask_predictor is None:
            ...
            # replicate the layer for the classification module
            #mask_predictor_s2 = MaskRCNNPredictor(mask_predictor_in_channels,
            #                                   mask_dim_reduced, num_classes)
        ...
        super(MaskRCNN, self).__init__(
            ...
            # Alex
            #box_score_thresh_classifier, box_nms_thresh_classifier, box_head_s2, box_predictor_s2, s2classifier)
